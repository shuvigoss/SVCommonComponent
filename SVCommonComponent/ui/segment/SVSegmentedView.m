...
- (void)commonInit{
  ...
  _defaultFont = [UIFont fontWithName:SV_SEGMENTEDVIEW_DEFAULT_FONT_NAME size:16.f];
  _defaultFontColor = [UIColor grayColor];
  _selectedFontColor = [UIColor redColor];
  _selectedFontSize = 18.f;
...
- (void)setTitles:(NSArray *)titles{
  _titles = titles;
  if ([_titleViews count] > 0) {[_titleViews makeObjectsPerformSelector:@selector(removeFromSuperview)]; [_titleViews removeAllObjects];}
